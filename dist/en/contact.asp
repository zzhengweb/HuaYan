  ...
  <div class="contact_wrapper">
    <div class="container">
      ...
      <div class="contact_info">
        <div class="info_top">
          <div class="top_line">Add.：No.8 Daming Road, High Technology Industrial Park, Changshu Suzhou, Jiangsu Province, China</div>
...
<script>
    ...
    function addMapOverlay() {
        // 百度地图API功能
        var content = '<div style="margin:0;line-height:20px;padding:2px;">' + 'Add.：No.8 Daming Road, High Technology Industrial Park, Changshu Suzhou, Jiangsu Province, China<br/>Tel：0512-80655555<br/>Fax：0512-52292707<br/>E-mail：info@hvha.cn' + '</div>';

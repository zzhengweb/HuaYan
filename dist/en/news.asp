...
<body>
  ...
  <div class="news_wrapper">
    <div class="container">
      <div class="news_bg">
          <%
            sql="select id,ContentTitle,ContentThumb,ContentBrief,CreateDate from  GswTblContent where CustomerId=221 and FunctionId=333 order by CreateDate desc"
